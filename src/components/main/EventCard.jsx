...
function EventCard() {
  return (
    <>
      <article>
        <section>
          <h1 className="font-md font-bold px-12 pt-12 py-2">
        ...
        <div className="w-full overflow-x-auto flex flex-row py-6 m-2">
          <div className="snap-center pl-4">
            <img
              className="object-cover shrink-0 max-w-40 max-h-30 rounded-lg shadow-md"
