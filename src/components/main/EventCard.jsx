  ...
  return (
    <>
      <article>
        ...
        <div className="w-full overflow-x-auto flex flex-row py-10">
          <div className="snap-center pl-4">
            <img
              className="h-full w-full object-cover shrink-0 rounded-lg shadow-xl"
          ...
          <div class="snap-center px-4">
            <img
              className="h-full w-full object-cover shrink-0 w-80 h-40 rounded-lg shadow-xl"
        ...
        <p className="text-sm px-12 pb-4">
        ...
        <p className="text-sm px-12">
          ...
          accomplishment in the Finnjolle event not only brought pride to Sweden
          but also highlighted the excellence of athletes in the sport of
          sailing.
        </p>
      </article>
    </>
