  ...
  return (
    <div className="max-w-full overflow-x-auto bg-white">
      <div className="inline-flex justify-between items-center py-[1em] px-[1.5em]">
        <button className=" text-[#999999] font-bold w-20 py-[0.3em] px-[1em] my-0 mx-4 border-solid border-2 border-[#999999] rounded-3xl hover:bg-[#348DB3] hover:text-white">
          Now
        </button>
