...
function HamburgerMenu() {
  ...
  return (
    <>
      <div className="bg-gray-100" style="min-height: 192px">
  <header x-data="{ open: false }" className="bg-white shadow">
    <div
      className="max-w-7xl mx-auto px-2 sm:px-4 lg:divide-y lg:divide-gray-200 lg:px-8"
    >
...
Heroicon name: outline/x"
      ...
      >
        <a
          ...
          x-state:on="Current"
          x-state:off="Default"
          x-state-description='Current: "bg-gray-100 text-gray-900", Default: "text-gray-900 hover:bg-gray-50 hover:text-gray-900"'
        >
          Dashboard
        </a>
        ...
        <a
          ...
          x-state-description='undefined: "bg-gray-100 text-gray-900", undefined: "text-gray-900 hover:bg-gray-50 hover:text-gray-900"'
        >
          Team
        </a>
